...
export async function enriquecerMetadatos(datosBase, contexto = {}) {
    ...
    const CAMPOS_INTERNOS = ['cubierta_base64', 'imagen_adicional', 'sinopsis_nativa', 'texto_legible', 'paginas', '_error', 'isbn_candidatos', 'isbn_propio', 'esFechada', 'isbns_rol', 'cip', 'comic_serie', '_isbnBloqueado'];
